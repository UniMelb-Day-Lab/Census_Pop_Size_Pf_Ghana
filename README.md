...
All data associated with this study, including de-identified individual participant data, are available in the manuscript, appendicies, and on GitHub [Census_Pop_Size_Pf_Ghana](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data).
...
_Tiedje KE, Zhan Q, Ruybal-Pésantez S, Tonkin-Hill G, He Q, Tan MH, Argyropoulos DC, Deed SL, Ghansah A, Bangre O, Oduro AR, Koram KA, Pascual M, Day KP. (2025) Measuring changes in _Plasmodium falciparum_ census population size in response to sequential malaria control interventions. eLife 12: RP91411 [https://elifesciences.org/articles/91411](https://elifesciences.org/articles/91411)_
...
* **Figures**
  * Figure 1 B (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig1_B_all_prev.csv)
  * Figure 1 C (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig1_C_age_prev.csv)
  * Figure 3 A & B (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig3_MOI_estimation_pool.csv)
  * Figure 3 - figure supplement 1 (i.e., DBLa_upsA_rep_size and DBLa_upsBC_rep_size vs. survey_year)
  * Figure 3 - figure supplement 2 (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig3_S2_MOI_estimation_mixtureDist.csv)
  * Figure 4 A (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig4_A_all_census.csv)
  * Figure 4 B (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig4_B_age_census.csv)
  * Figure 4 C (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig4_C_all_prev_census.csv)
  * Figure 4 D (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig4_D_age_prev_census.csv)
  * Appendix 1-Figure 1 (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Appendix1_Fig1_meanMOI_subsampling.csv)
  * Appendix 1-Figure 4 (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Appendix1_Fig4_measurementError.csv) 
...
This dataset represents the underlying source data used to generate the figures and tables listed below. In addition, we have provided supplementary source data files derived from this dataset for specific figures and tables where relevant.
* **Figures**
  * Figure 5 A and B (see [Source Data](https://github.com/UniMelb-Day-Lab/Census_Pop_Size_Pf_Ghana/tree/main/data/source_data): Fig5_A_B_richness_prev.csv)
